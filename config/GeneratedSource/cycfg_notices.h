...
#if !defined(CYW55310IUBGT)
#error "Unexpected MPN; expected DEVICE:=CYW55310IUBGT. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYW55310IUBGT) */
